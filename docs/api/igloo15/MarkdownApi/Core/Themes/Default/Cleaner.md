...
| Return | Name | Summary | 
| --- | --- | --- | 
| [String](https://docs.microsoft.com/en-us/dotnet/api/System.String) | BoldName ( [`String`](https://docs.microsoft.com/en-us/dotnet/api/System.String) name ) | Display the bold version of the string | 
